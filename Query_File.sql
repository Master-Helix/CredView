...
-- 3. Copy the Original csv data into SQL

-- copy cc_detail table

COPY cc_detail
FROM 'C:\Users\raksh\Desktop\Data Analytics\PowerBI E2E Credit Card Full Project\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\raksh\Desktop\Data Analytics\PowerBI E2E Credit Card Full Project\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Users\raksh\Desktop\Data Analytics\PowerBI E2E Credit Card Full Project\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\raksh\Desktop\Data Analytics\PowerBI E2E Credit Card Full Project\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
